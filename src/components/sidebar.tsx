...
const nav = [
  ...
  { label: "Saved Views", href: "/views", icon: FilterIcon },
  { label: "Import", href: "/import", icon: UploadIcon },
  { label: "Reports", href: "/reporting", icon: ChartIcon },
];
  ...
  return (
    <>
      ...
      <div className="flex h-14 items-center justify-between border-b border-zinc-200 bg-white px-4 lg:hidden">
        <Link href="/dashboard" className="flex items-center gap-2 text-lg font-bold text-zinc-900">
          <BedrockLogo className="h-6 w-6" />
          Bedrock
        </Link>
      ...
      <aside className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-60 lg:flex-col">
        <div className="flex flex-1 flex-col border-r border-zinc-200 bg-white">
          <div className="flex h-16 items-center gap-2.5 px-6">
            <BedrockLogo className="h-7 w-7 shrink-0" />
...
// Bedrock logo mark — layered stone/foundation icon
