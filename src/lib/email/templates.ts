...
export function clientInvitationEmail(params: {
  ...
  return {
    subject: `You've been invited to ${params.companyName} on Staffing Engine`,
    html: layout(`
      <h2 style="margin:0 0 8px;font-size:18px">You're invited</h2>
      <p style="font-size:14px;color:#52525b;line-height:1.6">
        ${params.inviterName} has invited you to join <strong>${params.companyName}</strong> on Staffing Engine.
